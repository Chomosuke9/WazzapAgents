...
const SLASH_CMD_RE = /^\/(setting|broadcasts?|prompts?|resets?|permissions?|infos?|modes?|triggers?|dashboards?|helps?|debugs?|joins?|stickers?|models?|modelcfgs?)\b\s*([\s\S]*)/i;
